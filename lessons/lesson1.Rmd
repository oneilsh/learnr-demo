...
The same technology can be used to build and deploy data dashboards; for an example (from a standard demo) click [here](http://mybinder.org/v2/gh/oneilsh/r/master?urlpath=shiny/bus-dashboard/).

A fairly neat option for data exploration is provided by the [`esquisse`](https://dreamrs.github.io/esquisse/index.html) library; click [here](http://mybinder.org/v2/gh/oneilsh/r/master?urlpath=shiny/esquisse.Rmd) to see an interactive demo. 
...
It will be useful to consider the pros and cons of learning via this "on-rails" experience vs. within the RStudio IDE itself.
